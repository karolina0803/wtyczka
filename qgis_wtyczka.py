...
class WtyczkaQGIS:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WtyczkaQGIS', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgis_wtyczka/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'qgis_wtyczka_1'),
            callback=self.run,
